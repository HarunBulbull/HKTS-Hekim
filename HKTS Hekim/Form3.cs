...
namespace HKTS_Hekim
{
    public partial class Form3 : Form
    {
        ...
        {
            int x = int.Parse(kapat.BackColor.ToString().Split('=')[3].Split(',')[0]);
            if (x > 14)
            {
                x -= 15;
                kapat.BackColor = Color.FromArgb(254, x, x);
            }
            else if (x == 14)
            {
                kapat.BackColor = Color.FromArgb(254, 0, 0);
            }
            else
            {
                kapat1.Stop();
        ...
        private void kapat2_Tick(object sender, EventArgs e)
        {
            ...
            {
                kapat.BackColor = Color.FromArgb(254, 254, 254);
            }
            else
            {
                kapat2.Stop();
        ...
        {
            int x = int.Parse(kucult.BackColor.ToString().Split('=')[3].Split(',')[0]);
            if (x > 14)
            {
                x -= 15;
                kucult.BackColor = Color.FromArgb(x, x, 254);
            }
            else if (x == 14)
            {
                kucult.BackColor = Color.FromArgb(0, 0, 254);
            }
            else
            {
                kucult1.Stop();
        ...
        private void kucult2_Tick(object sender, EventArgs e)
        {
            ...
            {
                kucult.BackColor = Color.FromArgb(254, 254, 254);
            }
            else
            {
                kucult2.Stop();
